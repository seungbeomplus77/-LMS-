    ...
    <div class="body-container">
      ...
      <div class="category-buttons mb-3 mt-4">
        <div class="btn-group d-flex" role="group" aria-label="FAQ 카테고리">
          <c:url var="urlAll" value="/faq/main">
            <c:param name="categoryId" value="1" />
          </c:url>
          <c:url var="urlNew" value="/faq/main">
            <c:param name="categoryId" value="2" />
          </c:url>
          <c:url var="urlTransfer" value="/faq/main">
            <c:param name="categoryId" value="3" />
          </c:url>
          <c:url var="urlSpecial" value="/faq/main">
            <c:param name="categoryId" value="4" />
          </c:url>
          <c:url var="urlBest" value="/faq/main">
          ...
          <a href="${pageContext.request.contextPath}/faq/main?categoryId=4" class="btn btn-outline-secondary flex-fill rounded-0 fw-bold">기숙사</a>
          <a href="${pageContext.request.contextPath}/faq/main?categoryId=5" class="btn btn-outline-secondary flex-fill rounded-0 fw-bold">동아리/대외활동</a>
        </div>
      </div>
