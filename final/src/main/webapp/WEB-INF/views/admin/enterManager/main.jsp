...
<div class="category-buttons mb-3 mt-4">
  <div class="btn-group d-flex" role="group" aria-label="입학안내 카테고리">
    <c:url var="urlAll" value="/admin/enterManager/main">
      <c:param name="categoryId" value="1" />
    </c:url>
    <c:url var="urlNew" value="/admin/enterManager/main">
      <c:param name="categoryId" value="2" />
    </c:url>
    <c:url var="urlTransfer" value="/admin/enterManager/main">
      <c:param name="categoryId" value="3" />
    </c:url>
    <c:url var="urlSpecial" value="/admin/enterManager/main">
    ...
    <a href="${pageContext.request.contextPath}${urlTransfer}" class="btn btn-outline-secondary flex-fill rounded-0 fw-bold">전편입</a>
   	<a href="${pageContext.request.contextPath}/admin/enterManager/main?categoryId=4" class="btn btn-outline-secondary flex-fill rounded-0 fw-bold">특별전형</a>
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
    	...
    	<td>
			<a href="${pageContext.request.contextPath}/admin/enterManager/article/${dto.enterGuideNum}?page=${page}${not empty query ? '&' : ''}${query}" class="text-reset">
			    ${dto.subject}
			</a>
    	</td>
    	<td>
...
<div class="col text-end">
  <button type="button" class="btn btn-primary" onclick="location.href='${pageContext.request.contextPath}/admin/enterManager/write';">게시글 등록</button>
</div>  
...
<script type="text/javascript">
  ...
  function searchList() {
    ...
    const url = '${pageContext.request.contextPath}/admin/enterManager/main';
