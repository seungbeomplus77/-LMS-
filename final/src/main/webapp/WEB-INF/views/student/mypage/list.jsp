    ...
    <div class="container mt-4">
        <div class="card shadow-sm" style="max-width: 600px; margin: 0 auto; border-radius: 10px;">
            <div class="card-body text-center">
                ...
                <p class="card-text text-muted mt-3">나의 학년/반: <strong>3-2</strong></p>
                <p class="card-text text-muted">이번학기취득학점: <strong>80</strong></p>
                <p class="card-text text-muted">졸업까지남은학점: <strong>50</strong></p>
