...
<nav class="navbar navbar-expand-lg main-navbar">
  <div class="container">
      ...
      <ul class="navbar-nav fw-bold">
        ...
        <li class="nav-item dropdown">
          ...
          data-bs-toggle="dropdown" aria-expanded="false" onclick="location.href=this.href">학점안내</a>
            ...
            <li><a class="dropdown-item" href="${pageContext.request.contextPath}/gradeGuide/main">이수기준/졸업요건</a></li>
            <li><a class="dropdown-item" href="${pageContext.request.contextPath}/gradeGuide/main">교과목구성/학점배정</a></li>       
            <li><a class="dropdown-item" href="${pageContext.request.contextPath}/gradeGuide/main">성적산출방법</a></li>       
           </ul>
        </li>
    ...
    <a class="nav-icon" href="${pageContext.request.contextPath}/"><i class="menu--icon bi bi-h-square"></i></a>
    <a class="nav-icon" href="${pageContext.request.contextPath}/member/logout"><i class="menu--icon bi bi-unlock"></i></a>
  </div>	    
</nav>