...
<div class="breadcrumb">
  ...
  <div class="sub-sub-breadcrumb">
    <span>></span>
	<a href="#" class="font-size small fw-bold">계정관리</a> 	
  </div>
  </div>
</div>
...
<div class="body-title">
  <h3 class="me-5"><i class="bi bi-question-circle"></i> 계정관리</h3>
...
<button type="button" class="btn btn-outline-secondary flex-fill rounded-0 fw-bold">교사</button>
<button type="button" class="btn btn-outline-secondary flex-fill rounded-0 fw-bold">학생</button>
  </div>
</div>
...
<table class="table">
  ...
  <tbody>
    <tr>
      ...
      <td>교사</td>
      <td>활성</td>
      <td>ech0782@naver.com</td>
      <td>서울시 용산구 이태원 2동 111-1 1층</td>
      <td class="align-middle text-center">
        <button type="button" class="btn btn-primary btn-sm d-flex justify-content-center align-items-center"
          style="height: 28px; width: 90px;" data-bs-toggle="modal" data-bs-target="#exampleModal">
          상세 보기
        </button>
      </td>      
    </tr>
