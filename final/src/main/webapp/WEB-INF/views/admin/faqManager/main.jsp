...
<button type="button" class="btn btn-outline-secondary flex-fill rounded-0 fw-bold">고교학점제란?</button>
<button type="button" class="btn btn-outline-secondary flex-fill rounded-0 fw-bold">학교생활</button>
<button type="button" class="btn btn-outline-secondary flex-fill rounded-0 fw-bold">기숙사</button>
<button type="button" class="btn btn-outline-secondary flex-fill rounded-0 fw-bold">동아리/대외활동</button>
  </div>
</div>
